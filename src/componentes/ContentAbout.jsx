    ...
    <>
      <div className="about-container">
        ...
        <div className="about-text">
          <h2>Sobre Mim</h2>
          <p>Meu nome é Jackson e sou um desenvolvedor de software para web apaixonado por tecnologia e inovação. Além do mundo da programação, sou um amante de esportes como slackline e musculação, que me mantêm em forma e em sintonia com minha rotina de trabalho. Além disso, minha paixão pela cozinha e fermentação de alimentos e bebidas me tornaram um cozinheiro e padeiro habilidoso e muito curioso, sempre experimentando novas receitas e técnicas para descobrir novos sabores e aromas.</p>
